...
- make dropout very low in one of them (0.1)
- experiment with making the learning rate a little bigger 
- experiment with making the weight decay a little smaller 
"""
